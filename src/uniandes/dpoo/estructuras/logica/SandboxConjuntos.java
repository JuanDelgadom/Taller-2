...
public class SandboxConjuntos
{
    ...
    {
    	Object[] cadenas = arbolCadenas.toArray();
    	List<String> listaInvertida = new ArrayList<>();
    	for(int i = arbolCadenas.size(); i-- > 0;) {
        	listaInvertida.add(cadenas[i].toString());
        }
    ...
    public Collection<String> getSiguientes( String cadena )
    {
    	...
    	if (arbolCadenas.contains(cadena))
    		cadenas.add(cadena);
    	for (String cadena1: arbolCadenas) {
    		if (cadena.compareTo(cadena1.toLowerCase()) < 0)
    			cadenas.add(cadena1);
    	}
        return cadenas;
    }
    ...
    {
    	int apariciones = 0;
    	for (String cadenaArbol : arbolCadenas) {
    		if(cadenaArbol == cadena)
    			apariciones ++;
    	}
    ...
    public void eliminarCadenaSinMayusculasOMinusculas( String cadena )
    {
    	...
    	for (String cadenaArbol : arbolCadenas) {
    		if (cadenaArbol.equalsIgnoreCase(cadena) == true)
    			lista.add(cadenaArbol);
    	}
    ...
    public void reiniciarConjuntoCadenas( List<Object> objetos )
    {
    	...
    	for(Object cadena: objetos)
    		arbolCadenas.add(cadena.toString());
    ...
    {
    	NavigableSet<String> arbolCadenasMayusculas = new TreeSet<String>( );
    	for(String cadena : arbolCadenas)
    		arbolCadenasMayusculas.add(cadena.toUpperCase());
    	
    	arbolCadenas = arbolCadenasMayusculas;
    ...
    {
    	TreeSet<String> arbolCadenasInvertida = new TreeSet<String>( );
    	arbolCadenasInvertida.addAll(arbolCadenas);
    	arbolCadenasInvertida.descendingSet();
        return arbolCadenasInvertida;
    }
